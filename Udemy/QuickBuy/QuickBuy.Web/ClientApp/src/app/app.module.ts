...
import { LojaPesquisaComponentComponent } from './loja/pesquisa/loja.pesquisa.component';
...
@NgModule({
  declarations: [
    ...
    LojaPesquisaComponentComponent,
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: 'app-loja.produto', component: LojaProdutoComponent},
