...
namespace Store.Tests.Entities
{
    ...
    {
        private readonly Customer _customer = new Customer("Eduardo", "edu@gmail.com");
        private readonly Product _product = new Product("Produto 1", 10, true);
        private readonly Discount _discount = new Discount(10, DateTime.Now.AddDays(5));
        private readonly OrderItem _item1 = new OrderItem(new Product("Produto 1", 10, true), 3);
        private readonly OrderItem _item2 = new OrderItem(new Product("Produto 2", 15, true), 2);
        private readonly OrderItem _item3 = new OrderItem(new Product("Produto 3", 2, true), 5);
        ...
        {
            var order = new Order(_customer, 0, null);
            order.AddItem(new Product("Produto 1", 10, true), 3);
            order.AddItem(new Product("Produto 2", 15, true), 2);
            order.AddItem(new Product("Produto 3", 2, true), 5);
            order.Pay(70.0m);
        ...
        {
            var order = new Order(_customer, 10, new Discount(20, DateTime.Now.AddDays(-1)));
            order.AddItem(_product, 5);
        ...
        {
            var discount = new Discount(10, DateTime.Now.AddDays(10));
